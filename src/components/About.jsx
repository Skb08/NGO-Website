...
const About = () => {
  return (
    <div>
        ...
        {/* companies stats */}
        <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-16 bg-gray-100 '>
            <div className='flex flex-col md:flex-row justify-between items-center py-6'>
                <div className='md:w-1/2' data-aos="zoom-out-right" data-aos-duration="1000" data-aos-offset="170" data-aos-easing="ease-in-out">
